...
if ( ! class_exists( 'Automobile_Mechanic_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Automobile_Mechanic_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Automobile_Mechanic_WPTT_WebFont_Loader( $url );
