...
class Automobile_Mechanic_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function automobile_mechanic_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function automobile_mechanic_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function automobile_mechanic_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function automobile_mechanic_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->automobile_mechanic_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function automobile_mechanic_load( $class ) {
