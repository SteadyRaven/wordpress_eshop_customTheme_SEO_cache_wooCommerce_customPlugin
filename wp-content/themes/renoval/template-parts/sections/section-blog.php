							...
							<div class="post-content">
								<div class="post-meta up">
									<span class="posted-on">
										<a href="<?php echo esc_url(the_date('Y/m/d')); ?>"> <span class="post-date"><?php echo esc_html(get_the_date('j')); ?></span> <?php echo esc_html(get_the_date('M')); ?><span class="post-date"> <?php echo esc_html(get_the_date('Y')); ?> </span>/</a>
									</span>
