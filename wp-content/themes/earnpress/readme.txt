...
2. Type in EarnPress in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.

== Copyright ==

EarnPress WordPress Theme, Copyright (c) 2020, ThemeArile
EarnPress is distributed under the terms of the GNU GPLs
...
* Image for Screenshot Image, Credit CC0 Public Domain
  ...
  Source: https://pxhere.com/en/photo/720925
  
* Image for Page Header Background Image, Credit CC0 rawpixel.com / 3353 Images
  License: CC0 1.0 Universal (CC0 1.0)
  License URL: https://pxhere.com/en/license
