...
<div class="header-image-box text-center">
  <div class="container">
    <?php if ( get_theme_mod('scuba_diving_sport_header_page_title' , true)) : ?>
      <h1><?php esc_html_e('404 Error!', 'scuba-diving-sport'); ?></h1>
    <?php endif; ?>
...
<div id="content">
	<div class="container">
		<div class="py-5 text-center">
			<p><?php esc_html_e('The page you are looking for may have been moved, deleted, or possibly never existed.', 'scuba-diving-sport'); ?></p>
			<?php get_search_form(); ?>
		</div>
	</div>
</div>
