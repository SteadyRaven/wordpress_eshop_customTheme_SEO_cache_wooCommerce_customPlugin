...
if ( ! class_exists( 'prime_interior_designer_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class prime_interior_designer_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new prime_interior_designer_WPTT_WebFont_Loader( $url );
