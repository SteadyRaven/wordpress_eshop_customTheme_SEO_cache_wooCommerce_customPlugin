...
if ( ! class_exists( 'Cinematic_Photographer_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Cinematic_Photographer_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Cinematic_Photographer_WPTT_WebFont_Loader( $url );
