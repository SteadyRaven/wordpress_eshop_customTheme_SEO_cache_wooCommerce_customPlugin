		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="page-box">
			    ...
			    <div class="box-content">
			       ...
			       <p><?php echo wp_trim_words(get_the_content(), get_theme_mod('cinematic_photographer_excerpt_count',35) );?></p>
		        	<?php if(get_theme_mod('cinematic_photographer_remove_read_button',true) != ''){ ?>
			            <div class="readmore-btn">
			                <a href="<?php echo esc_url( get_permalink() );?>" class="blogbutton-small" title="<?php esc_attr_e( 'Read More', 'cinematic-photographer' ); ?>"><?php echo esc_html(get_theme_mod('cinematic_photographer_read_more_text',__('Read More','cinematic-photographer')));?></a>
			            </div>
		        	<?php }?>
			    </div>
