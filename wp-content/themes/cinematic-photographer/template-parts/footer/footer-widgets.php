...
$number_of_footer_columns = get_theme_mod('cinematic_photographer_footer_columns', 4); // Change this value as needed.
...
?>
<div class="container">
    <aside class="widget-area row" role="complementary" aria-label="<?php esc_attr_e( 'Footer', 'cinematic-photographer' ); ?>">
